...
class DataSource
{
    ...
    public function select($query, $paramType = "", $paramArray = array())
    {
        ...
        $resultset = array(); // Initialize the array
    ...
    {
        $paramValueReference = array($paramType); // Initialize the array
    ...
    /**
     * To get the number of rows from the result of a SELECT query
     *
     * @param string $query
     * @param string $paramType
     * @param array $paramArray
