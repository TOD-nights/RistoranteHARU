...
CREATE TABLE `orders` (
  ...
  `paymentMode` enum('0','1','2','3','4') NOT NULL DEFAULT '0' COMMENT '0=cash on delivery, \r\n1=online \r\n2=mangio al ristorante\r\n3=ritiro al ristorante\r\n\r\n',
...
(38, 1, 'Via montegrappa 144, Via montegrappa 144', 20092, 3392143462, 3, '0', '0', '2023-10-30 21:01:50'),
(39, 1, 'Via montegrappa 144, Via montegrappa 144', 20092, 3392143462, 3, '0', '0', '2023-10-30 21:04:44'),
(40, 1, 'Via montegrappa 144, Via montegrappa 144', 20092, 3392143462, 3, '3', '0', '2023-10-30 21:05:42'),
(41, 1, 'Via montegrappa 144, Via montegrappa 144', 20092, 3392143462, 4, '3', '0', '2023-10-30 21:07:24'),
(42, 1, 'Via montegrappa 144, Via montegrappa 144', 20092, 3392143462, 3, '3', '0', '2023-10-30 21:09:51'),
(43, 1, 'Via montegrappa 144, Via montegrappa 144', 20092, 3392143462, 3, '3', '0', '2023-10-30 21:10:50'),
(44, 1, 'Via montegrappa 144, Via montegrappa 144', 20092, 3392143462, 3, '3', '0', '2023-10-30 21:22:24'),
(45, 1, 'Via montegrappa 144, Via montegrappa 144', 20092, 3392143462, 3, '', '0', '2023-10-30 21:22:50'),
(46, 1, 'Via montegrappa 144, Via montegrappa 144', 20092, 3392143462, 3, '0', '0', '2023-10-30 21:42:22'),
(47, 1, 'Via montegrappa 144, Via montegrappa 144', 20092, 3392143462, 3, '0', '0', '2023-10-30 21:56:28'),
(48, 1, 'Via montegrappa 144, Via montegrappa 144', 20092, 7777777777, 3, '0', '0', '2023-10-30 21:57:20');
...
--
-- 使用表AUTO_INCREMENT `contactreply`
--
ALTER TABLE `contactreply`
  MODIFY `id` int(21) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- 使用表AUTO_INCREMENT `deliverydetails`
--
ALTER TABLE `deliverydetails`
...
--
ALTER TABLE `orders`
  MODIFY `orderId` int(21) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;

--
-- 使用表AUTO_INCREMENT `sitedetail`
--
ALTER TABLE `sitedetail`
